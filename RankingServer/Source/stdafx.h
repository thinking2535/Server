...
using TRankingMap = CMultiIndexMap<SRankingUser, unique_index<TUID>, non_unique_index<__int32, greater<__int32>>>; // UID, Point
using TRankingMapArray = array<TRankingMap, (size_t)ERankingType::Max>;
...
extern CPeriod<seconds> g_RankingRefreshPeriod;
extern TNet g_Net;
